...
#####
#put here a class containing needed data for each specific buid dir
...
class WoTestcfg:
	wo_sanbox_root_dir = "/home/rusakov/WiseOpt/wiseopt-code/"

	def RootPath(self):
		envval = os.environ['WO_SANDBOX_DIR'];
		if (envval) :
			self.wo_sanbox_root_dir =  envval + "/";

		return self.wo_sanbox_root_dir
